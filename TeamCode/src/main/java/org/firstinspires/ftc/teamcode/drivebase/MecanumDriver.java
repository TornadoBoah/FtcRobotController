 ...
 */
public class MecanumDriver extends RobotDrive {
     ...
     */
    public MecanumDriver(Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
     ...
     * @param backRight  the back right motor
     */
    public MecanumDriver(boolean autoInvert, Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
